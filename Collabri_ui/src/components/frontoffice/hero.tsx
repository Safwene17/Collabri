...
const Hero = ({
    ...
    return (
        <section className="bg-background py-20 lg:py-30">
            <div className="max-w-screen-xl mx-auto w-full flex flex-col items-center gap-30 lg:my-0 lg:flex-row px-20">
                <div className="flex flex-col gap-7 lg:w-2/3">
                    ...
                    <p className="text-base text-muted-foreground md:text-lg lg:text-xl">
                        <TypingText text={description} duration={10} loop={true} holdDelay={5000} />          </p>
